...
auth_channel = environ.get('AUTH_CHANNEL', '-1002402219574')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002402219574'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002402219574') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '0')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MzMoviiez') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
