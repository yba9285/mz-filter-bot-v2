...
USERNAME = environ.get('USERNAME', "https://t.me/AoneMarathi") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002150303936'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/moviiezonerequest')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002124208809').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://metangevilas29:GyUAtsYGmMf4mGSH@cluster0.zq0ei.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "MzFileStore3")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Mz_Tg_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002150303936'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002150303936'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002286592825')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002387745957'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002150303936') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001952500080')) # 
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_open_mdiskshortner/4")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_open_modijilink/2")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "04d39f6f93164655a957b4ffd397defff9183148")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'Modijiurl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "cd6c1f59b3bb44988c8b4450ccd80e50fc9ef5b0")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'MdiskShortner.link')
SHORTENER_API3 = environ.get("SHORTENER_API3", "04d39f6f93164655a957b4ffd397defff9183148")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/o9V.jpg https://envs.sh/Hqt.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/H0J.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/Hqi.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
